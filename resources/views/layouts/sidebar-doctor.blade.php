<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen bg-gradient-to-b from-[#60A5FA] to-[#2563EB] transition-transform -translate-x-full lg:translate-x-0 shadow-xl" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto">
        <a href="{{ route('doctor.dashboard') }}" class="flex items-center pl-2.5 mb-8">
        ...
        <ul class="space-y-1 font-medium">
            <li>
                <a href="{{ route('doctor.dashboard') }}" class="flex items-center p-3 text-white/80 rounded-xl hover:bg-white/10 transition-all duration-200 {{ request()->routeIs('doctor.dashboard') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <div class="w-8 h-8 rounded-lg {{ request()->routeIs('doctor.dashboard') ? 'bg-white/20' : 'bg-white/10' }} flex items-center justify-center">
            ...
            <li class="pt-4 pb-2">
                <span class="text-xs font-semibold text-white/40 uppercase tracking-wider ms-3">Clinical</span>
            </li>

            <li>
                <a href="{{ route('doctor.dashboard') }}" class="flex items-center p-3 text-white/80 rounded-xl hover:bg-white/10 transition-all duration-200">
            ...
            <li class="pt-4 pb-2">
                <span class="text-xs font-semibold text-white/40 uppercase tracking-wider ms-3">Financial</span>
            </li>
            ...
            <li class="pt-4 pb-2">
                <span class="text-xs font-semibold text-white/40 uppercase tracking-wider ms-3">Settings</span>
            </li>
        ...
        <div class="absolute bottom-4 left-0 right-0 px-3">
            <div class="bg-white/10 rounded-xl p-3">
                <div class="flex items-center">
                    ...
                    <div class="ms-3">
                        <p class="text-sm font-medium text-white">{{ Auth::user()->name ?? 'Doctor' }}</p>
                        <p class="text-xs text-white/60">Doctor</p>
                    </div>
                </div>
            </div>
        </div>
