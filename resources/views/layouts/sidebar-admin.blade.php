<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen bg-gradient-to-b from-[#60A5FA] to-[#2563EB] transition-transform -translate-x-full lg:translate-x-0 shadow-xl" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto">
        ...
        <ul class="space-y-1 font-medium">
            ...
            <li>
                <a href="{{ route('admin.clinics.index') }}" class="flex items-center p-3 text-white/80 rounded-xl hover:bg-white/10 transition-all duration-200 {{ request()->routeIs('admin.clinics.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <div class="w-8 h-8 rounded-lg {{ request()->routeIs('admin.clinics.*') ? 'bg-white/20' : 'bg-white/10' }} flex items-center justify-center">
            ...
            <li>
                <a href="{{ route('admin.subscription-plans.index') }}" class="flex items-center p-3 text-white/80 rounded-xl hover:bg-white/10 transition-all duration-200 {{ request()->routeIs('admin.subscription-plans.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <div class="w-8 h-8 rounded-lg {{ request()->routeIs('admin.subscription-plans.*') ? 'bg-white/20' : 'bg-white/10' }} flex items-center justify-center">
            ...
            <li>
                <a href="{{ route('admin.settings.index') }}" class="flex items-center p-3 text-white/80 rounded-xl hover:bg-white/10 transition-all duration-200 {{ request()->routeIs('admin.settings.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <div class="w-8 h-8 rounded-lg {{ request()->routeIs('admin.settings.*') ? 'bg-white/20' : 'bg-white/10' }} flex items-center justify-center">
            ...
            <li>
                <a href="{{ route('admin.reports.index') }}" class="flex items-center p-3 text-white/80 rounded-xl hover:bg-white/10 transition-all duration-200 {{ request()->routeIs('admin.reports.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <div class="w-8 h-8 rounded-lg {{ request()->routeIs('admin.reports.*') ? 'bg-white/20' : 'bg-white/10' }} flex items-center justify-center">
